...
const CollaborationPage: React.FC = () => {
    ...
    const handleStartSession = async () => {
        ...
        setError('');
        try {
            const prompt = `Create a 5-question multiple-choice quiz about "${topic}". For each question, provide 4 answer options and the index of the correct answer (0-3). Respond with ONLY a valid JSON object with a single key "quiz" which is an array of 5 question objects. Example question object: { "question": "What is the capital of France?", "answers": ["Berlin", "Madrid", "Paris", "Rome"], "correct": 2 }`;
    ...
    const renderSession = () => (
        <div className="min-h-screen bg-[#0d1117] text-gray-200 p-4 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                {/* Center Column */}
                <div className="lg:col-span-2 bg-[#161b22] p-6 rounded-lg border border-gray-700 min-h-[60vh]">
                    {quiz && <QuizArea
                        quiz={quiz}
