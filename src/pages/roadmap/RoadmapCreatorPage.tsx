...
const RoadmapCreator: React.FC = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            if (currentMount && renderer.domElement) {
                // Check might be redundant but safe
    ...
    const handleGenerateRoadmap = async () => {
        ...
        setError('');
        try {
            const prompt = `Given the learning topic "${roadmapTopic}", generate a creative and gamified learning roadmap. Provide exactly 5 sequential level names. Also, create a 3-question multiple-choice "final boss" quiz about the topic. For each question, provide 4 options and the index of the correct answer (0-3). Respond with ONLY a valid JSON object with two keys: "levels" (an array of 5 strings for level names) and "bossQuestions" (an array of 3 question objects). Example for "Frontend Development": { "levels": [ "The HTML Foundation", "The CSS Styling Guild", "The JavaScript Sorcery", "The Framework Peaks", "The Deployment Dominion" ], "bossQuestions": [ { "question": "What does CSS stand for?", "answers": ["Computer Style Sheets", "Cascading Style Sheets", "Creative Style System", "Colorful Style Sheets"], "correct": 1 }, { "question": "Which is not a JavaScript framework?", "answers": ["React", "Vue", "Angular", "Laravel"], "correct": 3 }, { "question": "What tag is used for the largest heading?", "answers": ["<h6>", "<h1>", "<h2>", "<p>"], "correct": 1 } ] }`;
